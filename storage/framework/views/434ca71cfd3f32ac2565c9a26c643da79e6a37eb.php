...
<div class="flex justify-center items-center h-[80vh]">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg border border-gray-100">
        <div class="text-center mb-6">
            <h1 class="text-3xl font-bold text-blue-900">Login LMS</h1>
            <p class="text-gray-500 text-sm mt-1">Universitas Negeri Manado</p>
        </div>
        ...
        <?php if (isset($success)) { ?>
            <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 mb-4 text-sm" role="alert">
        ...
        <form action="/login" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" required placeholder="nama@unima.ac.id" class="w-full pl-10 border border-gray-300 rounded px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" required placeholder="••••••••" class="w-full pl-10 border border-gray-300 rounded px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm">
                </div>
            </div>
        ...
        <div class="mt-6 flex items-center justify-between text-sm">
            ...
            <a href="/register" class="text-blue-600 hover:text-blue-800 font-semibold hover:underline">Daftar Akun Baru</a>
        </div>
